...
# Sanity checks
for section in ["nasdaq-momentum", "yfinance"]:
    failed = False
...
# ---------------- Constants ----------------
now = datetime.now()
sconfig = config["nasdaq-momentum"]
yconfig = config["yfinance"]

# Stage 1
NASDAQ_100_LINK = sconfig.get("NASDAQ_100_LINK")
NASDAQ_100_TABLE_OFFSET = sconfig.getint("NASDAQ_100_TABLE_OFFSET")
NASDAQ_100_TABLE_SYMBOL_HEADER = sconfig.get("NASDAQ_100_TABLE_SYMBOL_HEADER")
...
tickers = df[NASDAQ_100_TABLE_SYMBOL_HEADER].to_list()
